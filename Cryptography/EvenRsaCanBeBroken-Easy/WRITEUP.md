## Judul & kategori soal
Even Rsa Can Be Broken? - Easy - [PICOCTF]

## Deskripsi soal
This service provides you an encrypted flag. Can you decrypt it with just N & e?

## Aha moment
Source Code encrypt.py yang diberikan oleh picoctf memiliki celah kerentanan pada code **p,q = get_primes(k//2)** sehingga hasil bilangan prima dari
N selalu menghasilkan angka genap, sedangkan untuk standar keamanan RSA harus menghasilkan bilangan ganjil.

## Langkah-langkah
1. Login ke server menggunakan perintah nc ke alamat server yang diberikan
2. Buat file baru dengan bahasa pemrograman python untuk decrypt RSA, source code dibawah ini:
```
...
decrypt()
```
3. Jalankan file python diatas dan demm flagnya berhasil didapatkan           
```                                                                         
FLAG:
